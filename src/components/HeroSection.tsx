...
const HeroSection = () => {
  ...
  return <section className="pb-12 md:pb-20 overflow-hidden bg-gradient-to-b from-primary/30 to-background">
    <div className="container-custom">
      ...
      <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
        ...
        <Button size="lg" className="shadow-lg text-white font-semibold text-lg py-6 px-8 rounded-full bg-violet-900 hover:bg-violet-800" onClick={() => document.getElementById("oferta")?.scrollIntoView({ behavior: "smooth" })}>
